...
for SAMPLE_ID in "${SAMPLE_IDS[@]}"; do
    ...
    sed "s|numcnas1.2_cnasize1e7_ploidy2_random0|${SAMPLE_ID}|g" ./zenodo_sample_sheet.tsv \
        > "zenodo_sample_sheets/zenodo_${SAMPLE_ID}_sheet.tsv"
    
    run_cnaster zenodo_sim_config \
